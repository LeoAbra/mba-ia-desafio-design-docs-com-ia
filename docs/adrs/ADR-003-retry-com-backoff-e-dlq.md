...
> **Divergência aritmética conhecida — emenda pendente.** A reunião registrou a soma dos cinco intervalos como "quase 15 horas" (`[09:17] Diego:`, aceita em `[09:17] Marcos:`), mas cinco chamadas HTTP consomem apenas **quatro** esperas: 1m+5m+30m+2h = **2h36min** entre a primeira falha e a última tentativa, e o intervalo de 12h fica inalcançável. Os dois números fixados nesta seção — teto de 5 tentativas e progressão de 5 intervalos — não fecham entre si, e **a contradição está na própria transcrição**: `[09:17] Larissa:` e o resumo de `[09:48] Larissa:` fecham "5 tentativas" junto com os cinco intervalos, enquanto a soma anunciada por Diego só se realiza se os cinco forem percorridos. Nenhuma fala desempata, então **este ADR não escolhe por conta própria**. Até a emenda, **a janela efetiva que vale em todos os documentos é 2h36min**; a implementação segue esta Decisão como está (5 chamadas, os cinco intervalos configurados, o último sem uso). A escolha a ratificar é entre manter 5 tentativas (janela 2h36min) ou subir para 6 (janela ~14h36min, que é o que a reunião acreditava estar comprando).
>
> **Onde a pendência é rastreada:** [RFC §6, "Quantas tentativas de entrega, afinal"](../RFC.md) — com responsáveis (Diego e Larissa), gatilho (a revisão técnica de `[09:50] Larissa:`) e a lista de itens que a escolha propaga. Aritmética completa no FDD §8.2; impacto de produto no PRD OBJ-4 e risco R-2.
...
- Cliente com indisponibilidade real — inclusive manutenção planejada de duas horas, caso já observado — continua recebendo o evento sem intervenção humana. **Ressalva da divergência acima:** a janela efetiva é de 2h36min, não das ~15h que a reunião supôs, então a cobertura desse cenário tem margem de 36 minutos e não é folgada.
...
- **Um evento leva 2h36min para ser declarado perdido — e a reunião acreditava ter comprado quase 15 horas.** Entre a primeira falha e a entrada na DLQ passam-se as quatro esperas efetivamente consumidas (1m + 5m + 30m + 2h); os 12h do quinto intervalo nunca são alcançados. Até lá a falha só existe no log e no histórico de entregas, que ninguém é obrigado a olhar. O custo que Marcos aceitou conscientemente foi o da janela longa — `[09:17] Marcos:` "Se um cliente meu cair por 15 horas, ele já tá com problema sério dele. Acho aceitável." —, e é justamente por isso que a divergência registrada na Decisão precisa de emenda antes do go-live: o que está implementado é a janela curta, não a que ele aprovou.
