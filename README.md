...
| 6 | [`docs/TRACKER.md`](./docs/TRACKER.md) | A referência cruzada: 630 linhas ligando cada item ao seu `[hh:mm] Nome:` ou caminho de arquivo. 84,1% com fonte `TRANSCRICAO`, 100 linhas com fonte `CODIGO`. É o instrumento que prova que nada foi inventado — e o lugar onde começar se você desconfiar de qualquer afirmação dos documentos acima. |
